...
class _TabScreen2State extends State<TabScreen2> {
                              ...
                              children: <Widget>[
                                 Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    fit: BoxFit.fill,
                                    image: NetworkImage(
                                    "https://mycarpool1234.000webhostapp.com/images/${data[index]['jobimage']}.jpg"
                                  )))),
                                Expanded(
                                  child: Container(
                                    child: Column(
  ...
  Future<String> makeRequest() async {
    String urlLoadJobs = "https://mycarpool1234.000webhostapp.com/php/load_job_user.php";
  ...
  Future<String> deleteRequest(String jobid) async {
    String urlLoadJobs = "https://mycarpool1234.000webhostapp.com/php/delete_job.php";
    ProgressDialog pr = new ProgressDialog(context,
        type: ProgressDialogType.Normal, isDismissible: false);
